...
public class IntercambioTest {
	...
	/*
	 * @Test public void
	 * testElJugador1IntercambiaUnaPropiedadPor30000ConElJugador2ElJugador2EsElNuevoPropietario
	 * () { Intercambio intercambio = jugador1.generarIntercambio(bsassur, new
	 * Dinero(30000)); intercambio.aceptarIntercambio(jugador2);
	 * Assert.assertEquals(jugador2, bsassur.getPropietario());
	 * Assert.assertTrue(jugador2.getPropiedades().contains(bsassur)); }
	 * 
	 * @Test public void
	 * testElJugador1IntercambiaUnaPropiedadPor20000ConElJugador2ElJugador1YaNoEsPropietario
	 * () { Intercambio intercambio = jugador1.generarIntercambio(bsassur, new
	 * Dinero(20000)); intercambio.aceptarIntercambio(jugador2);
	 * Assert.assertNotEquals(jugador1, bsassur.getPropietario());
	 * Assert.assertFalse(jugador1.getPropiedades().contains(bsassur)); }
	 * 
	 * @Test public void
	 * testElJugador1IntercambiaUnaPropiedadPor30000ConElJugador2ElJugador2Pierde30000
	 * () { Intercambio intercambio = jugador1.generarIntercambio(bsassur, new
	 * Dinero(30000)); intercambio.aceptarIntercambio(jugador2);
	 * Assert.assertEquals(jugador2, bsassur.getPropietario()); }
	 * 
	 * @Test public void
	 * testElJugador1IntercambiaUnaPropiedadPor20000ConElJugador2ElJugador1Gana20000
	 * () { Intercambio intercambio = jugador1.generarIntercambio(bsassur, new
	 * Dinero(20000)); intercambio.aceptarIntercambio(jugador2);
	 * Assert.assertEquals(jugador2, bsassur.getPropietario()); }
	 */
